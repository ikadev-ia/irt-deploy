...
<head>
    ...
    <title>Sécurité - Poulplume</title>
    ...
    <style>
        * {
        ...
        /* Bouton Accueil réduit (identique aux autres pages) */
        .home-btn {
            position: absolute;
            top: 20px;
            right: 25px;
        ...
        @media (max-width: 640px) {
            ...
            .home-btn { position: static; display: inline-block; margin-top: 12px; }
    ...
    <div class="sidebar-nav">
        ...
        <div class="settings-group">
            ...
            <div class="settings-sub" id="settingsSub">
                ...
                <a href="change_password.php" class="active"><i class="fas fa-key"></i> Sécurité</a>
            </div>
        </div>
        ...
        <div class="form-body">
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="new_password" required minlength="6" placeholder="Minimum 6 caractères">
                </div>
                <div class="form-group">
                    <label><i class=""></i> Confirmer le mot de passe</label>
